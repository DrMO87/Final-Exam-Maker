      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-7xl h-[94vh] flex flex-col overflow-hidden border border-slate-200">
        ...
        <div className="bg-slate-100 border-b border-slate-200 p-3 shrink-0 grid grid-cols-1 md:grid-cols-4 gap-3 text-xs">
          ...
          <div>
            ...
            <div className="h-8 px-3 rounded-lg border border-slate-200 bg-white font-bold text-[#002147] flex items-center">
        ...
        <div className="flex-1 overflow-auto p-4 bg-slate-200/80 flex justify-center">
          ...
          >
            <div>
              {/* TOP BRANDING HEADER MATCHING Supervisors Automated Assign REPORT_BRANDING */}
              ...
              {/* DOCUMENT HEADING & REPORT META CONTAINER MATCHING REPORT_STYLES */}
              <div className="text-center mb-5">
                ...
                {/* CLEAN REPORT META CARD (NO UGLY OVAL BADGES) */}
                                ...
                                <td key={pl} className="border border-slate-300 p-1 align-top bg-white">
                                  {assignedItems.length > 0 ? (
                                    assignedItems.map(item => (
                                      <div key={item.course_id} className="bg-white rounded border border-slate-300 p-1.5 mb-1 last:mb-0 shadow-2xs">
                      ...
                      {(sortedSchedule.length > 0 ? sortedSchedule : [
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="p-3 font-semibold text-[#002147]">{item.course?.course_title}</td>
            ...
            {/* DYNAMIC CONFIGURABLE SIGNATURES */}
            ...
            {/* DOCUMENT FOOTER MATCHING REPORT_STYLES EXACTLY */}
